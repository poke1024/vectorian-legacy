...
var $author$project$Server$toClient = _Platform_incomingPort('toClient', $elm$json$Json$Decode$string);
var $author$project$Vectorian$subscriptions = function (model) {
	return $author$project$Server$toClient($author$project$Msg$ReceiveDataFromServer);
};
var $author$project$Vectorian$AbortRequested = {$: 'AbortRequested'};
var $author$project$Vectorian$Searching = function (a) {
...
var $author$project$Server$toServer = _Platform_outgoingPort('toServer', $elm$json$Json$Encode$string);
var $author$project$Server$abortSearch = $author$project$Server$toServer(
	A2(
...
var $author$project$Vectorian$Match = F6(
	function (debug, score, algorithm, location, regions, omitted) {
		return {algorithm: algorithm, debug: debug, location: location, omitted: omitted, regions: regions, score: score};
	});
var $author$project$Vectorian$MatchDebugInfo = F2(
	function (document, sentence) {
...
var $author$project$Vectorian$matchDebugInfoDecoder = A3(
	...
	A3(
		...
		'document',
		$elm$json$Json$Decode$int,
		$elm$json$Json$Decode$succeed($author$project$Vectorian$MatchDebugInfo)));
var $author$project$Vectorian$MatchLocation = F4(
	function (speaker, author, work, location) {
		return {author: author, location: location, speaker: speaker, work: work};
	});
var $author$project$Vectorian$matchLocationDecoder = A3(
	$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'location',
	...
	A3(
		...
		A3(
			...
			A3(
				...
				'speaker',
				$elm$json$Json$Decode$string,
				$elm$json$Json$Decode$succeed($author$project$Vectorian$MatchLocation)))));
...
var $author$project$Vectorian$Region = F8(
	function (s, mismatch_penalty, t, similarity, weight, pos_s, pos_t, metric) {
		return {metric: metric, mismatch_penalty: mismatch_penalty, pos_s: pos_s, pos_t: pos_t, s: s, similarity: similarity, t: t, weight: weight};
	});
var $author$project$Vectorian$regionDecoder = A4(
					...
					A4(
						...
						A4(
							...
							A3(
								...
								's',
								$elm$json$Json$Decode$string,
								$elm$json$Json$Decode$succeed($author$project$Vectorian$Region)))))))));
var $author$project$Vectorian$matchDecoder = A4(
	$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$optional,
	'omitted',
	...
	A3(
		$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'regions',
		$elm$json$Json$Decode$list($author$project$Vectorian$regionDecoder),
		A3(
			$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
			'location',
			$author$project$Vectorian$matchLocationDecoder,
			A3(
				$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
				'algorithm',
				$elm$json$Json$Decode$string,
...
var $author$project$Vectorian$serverResultsMessageDecoder = A3(
	...
	A3(
		$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'results',
		$elm$json$Json$Decode$list($author$project$Vectorian$matchDecoder),
		A3(
			$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
			'command',
			$elm$json$Json$Decode$string,
...
var $author$project$Vectorian$SearchRequested = {$: 'SearchRequested'};
var $author$project$Server$CombineMin = {$: 'CombineMin'};
var $elm$json$Json$Encode$bool = _Json_wrap;
var $elm$json$Json$Encode$float = _Json_wrap;
var $elm$json$Json$Encode$int = _Json_wrap;
var $author$project$Server$similarityMeasureInternalId = function (m) {
	return m.quantiles ? ('ranked-' + m.name) : m.name;
};
var $author$project$Server$startSearch = F2(
	function (query, settings) {
		return $author$project$Server$toServer(
			A2(
				$elm$json$Json$Encode$encode,
				0,
				$elm$json$Json$Encode$object(
					_List_fromArray(
						[
							_Utils_Tuple2(
							'command',
							$elm$json$Json$Encode$string('start-search')),
							_Utils_Tuple2(
							'query',
							$elm$json$Json$Encode$string(query)),
							_Utils_Tuple2(
							'ignore_determiners',
							$elm$json$Json$Encode$bool(settings.ignoreDeterminers)),
							_Utils_Tuple2(
							'pos_weighting',
							$elm$json$Json$Encode$float(settings.posWeighting)),
							_Utils_Tuple2(
							'pos_mismatch',
							$elm$json$Json$Encode$float(settings.posMismatch)),
							_Utils_Tuple2(
							'mismatch_length_penalty',
							$elm$json$Json$Encode$int(settings.mismatchLengthPenalty)),
							_Utils_Tuple2(
							'submatch_weight',
							$elm$json$Json$Encode$float(settings.submatchWeight)),
							_Utils_Tuple2(
							'idf_weight',
							$elm$json$Json$Encode$float(settings.idfWeight)),
							_Utils_Tuple2(
							'bidirectional',
							$elm$json$Json$Encode$bool(settings.bidirectional)),
							_Utils_Tuple2(
							'similarity_threshold',
							$elm$json$Json$Encode$float(settings.similarityThreshold)),
							_Utils_Tuple2(
							'similarity_falloff',
							$elm$json$Json$Encode$float(settings.similarityFalloff)),
							_Utils_Tuple2(
							'similarity_measure',
							$elm$json$Json$Encode$string(
								$author$project$Server$similarityMeasureInternalId(settings.similarityMeasure))),
							_Utils_Tuple2(
							'cost_combine_function',
							$elm$json$Json$Encode$string(
								_Utils_eq(settings.costCombine, $author$project$Server$CombineMin) ? 'min' : 'sum')),
							_Utils_Tuple2(
							'mix_embedding',
							$elm$json$Json$Encode$float(settings.mixEmbedding)),
							_Utils_Tuple2(
							'enable_elmo',
							$elm$json$Json$Encode$bool(settings.enableElmo))
						]))));
	});
var $author$project$Vectorian$startSearch = function (model) {
...
var $author$project$Vectorian$updateQuerySettings = F2(
	function (settings, msg) {
		switch (msg.$) {
			case 'IgnoreDeterminers':
				var on = msg.a;
				return _Utils_update(
					settings,
					{ignoreDeterminers: on});
			case 'EnableElmo':
				var on = msg.a;
				return _Utils_update(
					settings,
			...
			case 'MismatchLengthPenalty':
				var m = msg.a;
				if (m.$ === 'Just') {
					var x = m.a;
					return _Utils_update(
						settings,
						{mismatchLengthPenalty: x});
				} else {
					return settings;
				}
			case 'SubmatchWeight':
			...
			case 'SimilarityThreshold':
				...
				if (m.$ === 'Just') {
					...
					return _Utils_update(
						settings,
						{similarityThreshold: x});
				} else {
					return settings;
				}
			case 'UpdateSimilarityMeasure':
				var m = msg.a;
				if (m.$ === 'Just') {
					var x = m.a;
					return _Utils_update(
...
var $author$project$Vectorian$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'NoOp':
			...
			case 'QueryKeyDown':
				var key = msg.a;
				return (key === 13) ? $author$project$Vectorian$startSearch(model) : _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			case 'StartSearch':
				return $author$project$Vectorian$startSearch(model);
			case 'AbortSearch':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{search: $author$project$Vectorian$AbortRequested}),
					$author$project$Server$abortSearch);
			case 'QueryInput':
				var s = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						...
						{query: s}),
					$elm$core$Platform$Cmd$none);
			case 'UpdateQuerySettings':
				var q = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							querySettings: A2($author$project$Vectorian$updateQuerySettings, model.querySettings, q)
						}),
					$elm$core$Platform$Cmd$none);
			default:
				switch (msg.a) {
					...
					case 'search-started':
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									search: $author$project$Vectorian$Searching($elm$core$Maybe$Nothing)
								}),
							$elm$core$Platform$Cmd$none);
					case 'search-aborted':
						return _Utils_Tuple2(
...
var $author$project$Msg$AnnotatePOS = function (a) {
	return {$: 'AnnotatePOS', a: a};
};
var $surprisetalk$elm_bulma$Bulma$Modifiers$Auto = {$: 'Auto'};
var $author$project$Msg$Bidirectional = function (a) {
	return {$: 'Bidirectional', a: a};
};
var $surprisetalk$elm_bulma$Bulma$Elements$H1 = {$: 'H1'};
var $author$project$Msg$IDFWeight = function (a) {
	return {$: 'IDFWeight', a: a};
};
var $author$project$Msg$IgnoreDeterminers = function (a) {
	return {$: 'IgnoreDeterminers', a: a};
};
var $surprisetalk$elm_bulma$Bulma$Modifiers$Left = {$: 'Left'};
var $author$project$Msg$MismatchLengthPenalty = function (a) {
	return {$: 'MismatchLengthPenalty', a: a};
};
var $author$project$Msg$MixEmbedding = function (a) {
	return {$: 'MixEmbedding', a: a};
};
var $author$project$Msg$NoOp = {$: 'NoOp'};
var $author$project$Msg$PosMismatch = function (a) {
	return {$: 'PosMismatch', a: a};
};
var $author$project$Msg$PosWeighting = function (a) {
	return {$: 'PosWeighting', a: a};
};
var $surprisetalk$elm_bulma$Bulma$Modifiers$Primary = {$: 'Primary'};
var $author$project$Msg$QueryInput = function (a) {
	return {$: 'QueryInput', a: a};
};
var $author$project$Msg$QueryKeyDown = function (a) {
...
var $author$project$Msg$UpdateQuerySettings = function (a) {
	return {$: 'UpdateQuerySettings', a: a};
};
var $surprisetalk$elm_bulma$Bulma$Modifiers$White = {$: 'White'};
var $surprisetalk$elm_bulma$Bulma$Modifiers$Width4 = {$: 'Width4'};
...
var $surprisetalk$elm_bulma$Bulma$Classes$isUnselectable = $elm$html$Html$Attributes$class('is-unselectable');
var $surprisetalk$elm_bulma$Bulma$Modifiers$unselectable = $surprisetalk$elm_bulma$Bulma$Classes$isUnselectable;
var $author$project$BulmaExtensions$checkbox = F3(
	function (attr, id, title) {
		return A2(
				...
				[
					...
					_Utils_ap(
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$class('is-checkradio')
							]),
						attr),
					_List_Nil),
					A2(
					...
					_List_fromArray(
						[
							...
							$surprisetalk$elm_bulma$Bulma$Modifiers$unselectable
						]),
					_List_fromArray(
						[
...
var $author$project$Vectorian$checked = function (flag) {
...
var $surprisetalk$elm_bulma$Bulma$Elements$progress = function (_v0) {
	var size = _v0.size;
	var color = _v0.color;
	return A2(
		$surprisetalk$elm_bulma$Helpers$node,
...
var $author$project$BulmaExtensions$intSlider = F3(
	function (max, attr, id) {
		return A2(
			$elm$html$Html$input,
			_Utils_ap(
				_List_fromArray(
...
var $surprisetalk$elm_bulma$Bulma$Classes$isInvisible = $elm$html$Html$Attributes$class('is-invisible');
var $surprisetalk$elm_bulma$Bulma$Modifiers$invisible = $surprisetalk$elm_bulma$Bulma$Classes$isInvisible;
...
var $surprisetalk$elm_bulma$Bulma$Modifiers$Typography$Small = {$: 'Small'};
...
var $surprisetalk$elm_bulma$Bulma$Classes$isItalic = $elm$html$Html$Attributes$class('is-italic');
var $surprisetalk$elm_bulma$Bulma$Modifiers$Typography$italicize = $surprisetalk$elm_bulma$Bulma$Classes$isItalic;
var $surprisetalk$elm_bulma$Bulma$Modifiers$Typography$Bold = {$: 'Bold'};
...
var $author$project$Vectorian$matchScoreView = function (match) {
	return A2(
		$elm$html$Html$span,
		_List_fromArray(
			[
				$surprisetalk$elm_bulma$Bulma$Modifiers$Typography$textWeight($surprisetalk$elm_bulma$Bulma$Modifiers$Typography$Bold)
			]),
		_List_fromArray(
			[
				$elm$html$Html$text(
				A2($myrho$elm_round$Round$round, 1, 100 * match.score) + '%')
			]));
};
...
var $surprisetalk$elm_bulma$Bulma$Classes$isPulledRight = $elm$html$Html$Attributes$class('is-pulled-right');
var $surprisetalk$elm_bulma$Bulma$Modifiers$pulledRight = $surprisetalk$elm_bulma$Bulma$Classes$isPulledRight;
var $surprisetalk$elm_bulma$Bulma$Modifiers$Typography$GreyLight = {$: 'GreyLight'};
var $surprisetalk$elm_bulma$Bulma$Modifiers$Typography$Black = {$: 'Black'};
var $surprisetalk$elm_bulma$Bulma$Modifiers$Typography$Danger = {$: 'Danger'};
var $surprisetalk$elm_bulma$Bulma$Modifiers$Light = {$: 'Light'};
var $author$project$Vectorian$opacity = function (region) {
	return 'opacity: ' + ($elm$core$String$fromFloat(region.weight) + ';');
};
var $surprisetalk$elm_bulma$Bulma$Modifiers$Success = {$: 'Success'};
var $surprisetalk$elm_bulma$Bulma$Modifiers$Warning = {$: 'Warning'};
var $author$project$Vectorian$scoreColor = function (score) {
	return (score <= 0.75) ? $surprisetalk$elm_bulma$Bulma$Modifiers$Warning : ((score <= 0.25) ? $surprisetalk$elm_bulma$Bulma$Modifiers$Danger : $surprisetalk$elm_bulma$Bulma$Modifiers$Success);
};
var $surprisetalk$elm_bulma$Bulma$Classes$tag = $elm$html$Html$Attributes$class('tag');
var $surprisetalk$elm_bulma$Bulma$Elements$tag = function (_v0) {
	var size = _v0.size;
	var color = _v0.color;
	var isLink = _v0.isLink;
	return A2(
		$surprisetalk$elm_bulma$Helpers$node,
		isLink ? 'a' : 'span',
		_List_fromArray(
...
var $surprisetalk$elm_bulma$Bulma$Elements$tagModifiers = {color: $surprisetalk$elm_bulma$Bulma$Modifiers$Default, isLink: false, size: $surprisetalk$elm_bulma$Bulma$Modifiers$Standard};
...
var $author$project$Vectorian$matchRegionView = F2(
	function (model, region) {
		...
		var s_html = A2(
			...
			_List_fromArray(
				[
					$surprisetalk$elm_bulma$Bulma$Modifiers$Typography$textWeight($surprisetalk$elm_bulma$Bulma$Modifiers$Typography$Bold),
					$surprisetalk$elm_bulma$Bulma$Modifiers$Typography$textColor($surprisetalk$elm_bulma$Bulma$Modifiers$Typography$Black)
				]),
			_List_fromArray(
				[
					$elm$html$Html$text(region.s)
				]));
		return A2(
			$elm$html$Html$span,
			_List_Nil,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							A2($elm$html$Html$Attributes$attribute, 'style', 'display:inline-table')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									A2($elm$html$Html$Attributes$attribute, 'style', 'display:table-row')
								]),
							_List_fromArray(
								[
									A2(
									...
									_List_fromArray(
										[
											A2($elm$html$Html$Attributes$attribute, 'style', 'display:table-cell')
										]),
									_List_fromArray(
										[s_html])),
									A2(
									...
									_List_fromArray(
										[
											...
											$elm$html$Html$Attributes$attribute,
											'style',
											'display:table-cell;' + $author$project$Vectorian$opacity(region))
										]),
									_List_fromArray(
										[
											$elm$html$Html$text(' '),
											...
											_Utils_update(
												$surprisetalk$elm_bulma$Bulma$Elements$tagModifiers,
												{
													color: $author$project$Vectorian$scoreColor(region.similarity)
												}),
											_List_Nil,
											_List_fromArray(
												[
													$elm$html$Html$text(
													$elm$core$String$fromInt(
														$elm$core$Basics$floor(100 * region.similarity)) + '%')
												]))
										]))
								])),
							model.querySettings.annotatePOS ? A2(
							$elm$html$Html$span,
							_List_fromArray(
								[
									A2($elm$html$Html$Attributes$attribute, 'style', 'display:table-row')
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											A2($elm$html$Html$Attributes$attribute, 'style', 'display:table-cell; padding-left: 0.2em; padding-right: 0.2em;'),
											$surprisetalk$elm_bulma$Bulma$Modifiers$Typography$textSize($surprisetalk$elm_bulma$Bulma$Modifiers$Typography$Small),
											$surprisetalk$elm_bulma$Bulma$Modifiers$Typography$textCentered,
											_Utils_eq(region.pos_s, region.pos_t) ? $surprisetalk$elm_bulma$Bulma$Modifiers$Typography$textColor($surprisetalk$elm_bulma$Bulma$Modifiers$Typography$Black) : $surprisetalk$elm_bulma$Bulma$Modifiers$Typography$textColor($surprisetalk$elm_bulma$Bulma$Modifiers$Typography$Danger)
										]),
									_List_fromArray(
										[
											$elm$html$Html$text(region.pos_s)
										])),
									A2(
									$elm$html$Html$span,
									_List_fromArray(
									...
									_List_fromArray(
										[
											$elm$html$Html$text(region.pos_t)
										])),
									A2(
									$elm$html$Html$span,
									_List_fromArray(
										[
											...
											$surprisetalk$elm_bulma$Bulma$Modifiers$Typography$textSize($surprisetalk$elm_bulma$Bulma$Modifiers$Typography$Small),
											$surprisetalk$elm_bulma$Bulma$Modifiers$Typography$textCentered,
											$surprisetalk$elm_bulma$Bulma$Modifiers$Typography$textColor($surprisetalk$elm_bulma$Bulma$Modifiers$Typography$GreyLight)
										]),
									_List_fromArray(
										[
											$elm$html$Html$text(region.metric)
										]))
								])) : A2($elm$html$Html$span, _List_Nil, _List_Nil)
						]))
				]));
	});
var $author$project$Vectorian$regionView = F2(
	function (model, region) {
		return (($elm$core$String$length(region.t) > 0) && ((region.similarity * region.weight) > 0)) ? A2($author$project$Vectorian$matchRegionView, model, region) : ((model.querySettings.annotatePOS && (region.mismatch_penalty > 0)) ? A2(
			$elm$html$Html$span,
			_List_Nil,
			_List_fromArray(
				[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$text(
											'-' + (A2($myrho$elm_round$Round$round, 1, 100 * region.mismatch_penalty) + '% rel'))
										]))
								]))
						]))
				])) : A2(
...
var $author$project$Vectorian$joinRegions = F3(
	function (left, rest, joinStr) {
		var _v1 = $elm$core$List$head(rest);
		if (_v1.$ === 'Just') {
			var h = _v1.a;
			return (!(h.similarity * h.weight)) ? A2(
				$author$project$Vectorian$trimRegionsHead,
				_Utils_ap(
					_List_fromArray(
						[
							{
...
var $author$project$Vectorian$trimRegionsHead = F2(
	function (regions, joinStr) {
		var _v0 = $elm$core$List$head(regions);
		if (_v0.$ === 'Just') {
			var r = _v0.a;
			return (!(r.similarity * r.weight)) ? A3(
				$author$project$Vectorian$joinRegions,
				r,
				A2($elm$core$List$drop, 1, regions),
				joinStr) : regions;
		} else {
			return regions;
		}
	});
var $author$project$Vectorian$trimRegions = function (r) {
	return $elm$core$List$reverse(
		A2(
			$author$project$Vectorian$trimRegionsHead,
...
var $author$project$Vectorian$matchView = F2(
				...
				[
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$author$project$Vectorian$matchScoreView(match),
											A2($elm$html$Html$br, _List_Nil, _List_Nil),
											A2(
											$elm$html$Html$div,
											_List_Nil,
											($elm$core$List$length(match.omitted) <= 2) ? A2(
												$elm$core$List$map,
												function (x) {
													return A2(
														$elm$html$Html$div,
														_List_fromArray(
															[
																A2($elm$html$Html$Attributes$attribute, 'style', 'text-decoration: line-through;')
															]),
														_List_fromArray(
															[
												...
												match.omitted) : _List_fromArray(
												[
													A2(
													$elm$html$Html$div,
													_List_fromArray(
														[
															A2($elm$html$Html$Attributes$attribute, 'style', 'white-space: nowrap;')
														]),
													_List_fromArray(
														[
															$elm$html$Html$text(
															$elm$core$String$fromInt(
																$elm$core$List$length(match.omitted)) + ' omitted')
														]))
												])),
											model.querySettings.annotateDebug ? A2(
											$elm$html$Html$div,
											_List_Nil,
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															...
															_List_fromArray(
																[
																	$elm$html$Html$text(
																	'd ' + $elm$core$String$fromInt(match.debug.document))
																])),
															A2(
															$elm$html$Html$div,
															_List_Nil,
															_List_fromArray(
																[
																	$elm$html$Html$text(
																	's ' + $elm$core$String$fromInt(match.debug.sentence))
																]))
														]))
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text(match.location.speaker)
								])),
							A2(
							$elm$html$Html$div,
							_List_fromArray(
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$text(match.location.author + ', ')
										])),
									A2(
									$elm$html$Html$small,
									_List_fromArray(
										[$surprisetalk$elm_bulma$Bulma$Modifiers$Typography$italicize]),
									_List_fromArray(
										[
											$elm$html$Html$text(match.location.work + ', ')
										])),
									A2(
									$elm$html$Html$small,
									_List_Nil,
									_List_fromArray(
										[
											$elm$html$Html$text(match.location.location)
										]))
								])),
							A2(
							$elm$html$Html$div,
								...
								[
									...
									A2(
										...
										A2(
											$elm$core$List$map,
											function (r) {
												return A2($author$project$Vectorian$regionView, model, r);
											},
											$author$project$Vectorian$trimRegions(match.regions))))
								]))
						]))
				]));
	});
var $author$project$BulmaExtensions$mismatchCutoffSlider = F2(
	function (attr, id) {
		return A2(
			$elm$html$Html$input,
			_Utils_ap(
				_List_fromArray(
					[
						...
						A2($elm$html$Html$Attributes$attribute, 'max', '30'),
						A2($elm$html$Html$Attributes$attribute, 'step', '1'),
						$elm$html$Html$Attributes$type_('range')
					]),
				attr),
...
var $author$project$MismatchPenalty$chartContainerConfig = $terezka$line_charts$LineChart$Container$custom(
	{
		attributesHtml: _List_Nil,
		attributesSvg: _List_Nil,
		id: 'chart-id',
		margin: A4($terezka$line_charts$LineChart$Container$Margin, 0, 0, 40, 60),
...
var $terezka$line_charts$LineChart$Axis$Ticks$float = $terezka$line_charts$Internal$Axis$Ticks$float;
...
var $author$project$MismatchPenalty$yAxisConfig = $terezka$line_charts$LineChart$Axis$custom(
	{
		axisLine: $terezka$line_charts$LineChart$Axis$Line$rangeFrame($terezka$line_charts$LineChart$Colors$gray),
		pixels: 400,
		range: A2($terezka$line_charts$LineChart$Axis$Range$window, 0, 100),
		ticks: $terezka$line_charts$LineChart$Axis$Ticks$float(4),
		title: $terezka$line_charts$LineChart$Axis$Title$default(''),
		variable: A2(
			$elm$core$Basics$composeL,
			$elm$core$Maybe$Just,
			function ($) {
...
var $author$project$MismatchPenalty$chartConfig = function (size) {
	return {
		area: $terezka$line_charts$LineChart$Area$stacked(0.5),
		container: $author$project$MismatchPenalty$chartContainerConfig,
		...
		x: A4(
			$terezka$line_charts$LineChart$Axis$picky,
			700,
			'',
			function ($) {
				return $.words;
		...
		y: $author$project$MismatchPenalty$yAxisConfig
	};
};
...
var $author$project$MismatchPenalty$MismatchWeightData = F2(
	function (words, weight) {
		return {weight: weight, words: words};
	});
var $author$project$MismatchPenalty$mismatchPenaltyCurveData = F2(
	function (cutoff, x) {
		return A2(
			$author$project$MismatchPenalty$MismatchWeightData,
			x,
			100 * A2(
				$elm$core$Basics$min,
				1,
				1 - A2($elm$core$Basics$pow, $elm$core$Basics$e, -(x / (cutoff / 0.693147)))));
	});
...
var $author$project$MismatchPenalty$mismatchPenaltyCurve = F2(
	function (cutoff, size) {
		var s = A2($elm$core$Basics$max, size, cutoff);
		return A2(
			$terezka$line_charts$LineChart$viewCustom,
			$author$project$MismatchPenalty$chartConfig(s),
			_List_fromArray(
				[
					A4(
					$terezka$line_charts$LineChart$line,
					$terezka$line_charts$LineChart$Colors$grayLight,
					$terezka$line_charts$LineChart$Dots$none,
					'mismatch-penalty',
					A3(
						$elm$core$List$map2,
						$author$project$MismatchPenalty$mismatchPenaltyCurveData,
						A2($elm$core$List$repeat, s, cutoff),
						A2(
							$elm$core$List$map,
							$elm$core$Basics$toFloat,
							A2($elm$core$List$range, 1, s))))
				]));
	});
...
var $author$project$Vectorian$onKeyDown = function (tagger) {
	return A2(
		$elm$html$Html$Events$on,
		'keydown',
		A2($elm$json$Json$Decode$map, tagger, $elm$html$Html$Events$keyCode));
};
var $author$project$Vectorian$targetFloat = A2(
	$elm$json$Json$Decode$map,
	$elm$core$String$toFloat,
	A2(
		$elm$json$Json$Decode$at,
		_List_fromArray(
			['target', 'value']),
		$elm$json$Json$Decode$string));
var $author$project$Vectorian$onSliderInput = function (tagger) {
	return A2(
		$elm$html$Html$Events$on,
		'input',
		A2($elm$json$Json$Decode$map, tagger, $author$project$Vectorian$targetFloat));
};
var $elm$html$Html$Attributes$placeholder = $elm$html$Html$Attributes$stringProperty('placeholder');
var $surprisetalk$elm_bulma$Bulma$Elements$progressModifiers = {color: $surprisetalk$elm_bulma$Bulma$Modifiers$Default, size: $surprisetalk$elm_bulma$Bulma$Modifiers$Standard};
var $surprisetalk$elm_bulma$Bulma$Classes$isPulledLeft = $elm$html$Html$Attributes$class('is-pulled-left');
var $surprisetalk$elm_bulma$Bulma$Modifiers$pulledLeft = $surprisetalk$elm_bulma$Bulma$Classes$isPulledLeft;
var $author$project$Msg$AbortSearch = {$: 'AbortSearch'};
var $surprisetalk$elm_bulma$Bulma$Modifiers$Active = {$: 'Active'};
var $surprisetalk$elm_bulma$Bulma$Modifiers$Loading = {$: 'Loading'};
var $author$project$Msg$StartSearch = {$: 'StartSearch'};
...
var $author$project$Vectorian$searchButton = function (model) {
	var s = function () {
		var _v0 = model.search;
		switch (_v0.$) {
			case 'NotSearching':
				return {color: $surprisetalk$elm_bulma$Bulma$Modifiers$Primary, msg: $author$project$Msg$StartSearch, state: $surprisetalk$elm_bulma$Bulma$Modifiers$Active, text: 'Search'};
			case 'Searching':
				return {color: $surprisetalk$elm_bulma$Bulma$Modifiers$Danger, msg: $author$project$Msg$AbortSearch, state: $surprisetalk$elm_bulma$Bulma$Modifiers$Active, text: 'Abort'};
			case 'SearchRequested':
				return {color: $surprisetalk$elm_bulma$Bulma$Modifiers$Primary, msg: $author$project$Msg$StartSearch, state: $surprisetalk$elm_bulma$Bulma$Modifiers$Loading, text: 'Search'};
			default:
				return {color: $surprisetalk$elm_bulma$Bulma$Modifiers$Danger, msg: $author$project$Msg$AbortSearch, state: $surprisetalk$elm_bulma$Bulma$Modifiers$Loading, text: 'Abort'};
		}
	}();
	return A4(
		...
		_Utils_update(
			...
			{color: s.color, state: s.state}),
		_List_Nil,
		_List_fromArray(
			[
				$elm$html$Html$Events$onClick(s.msg)
			]),
		_List_fromArray(
			[
...
var $author$project$BulmaExtensions$optionalCheckbox = F4(
	function (visible, attr, id, title) {
		return A2(
			$surprisetalk$elm_bulma$Bulma$Form$field,
			visible ? _List_Nil : _List_fromArray(
...
var $author$project$BulmaExtensions$radio = F3(
	function (attr, id, title) {
		return A2(
			$surprisetalk$elm_bulma$Bulma$Form$field,
			_List_Nil,
					...
					_Utils_ap(
						_List_fromArray(
							[
								...
								A2($elm$html$Html$Attributes$attribute, 'name', 'bla'),
								$elm$html$Html$Attributes$class('is-checkradio')
							]),
						attr),
					_List_Nil),
			...
			_Utils_ap(
				_List_fromArray(
					[
						...
						A2($elm$html$Html$Attributes$attribute, 'min', '0'),
						A2($elm$html$Html$Attributes$attribute, 'max', '100'),
						A2($elm$html$Html$Attributes$attribute, 'step', '25'),
						$elm$html$Html$Attributes$type_('range')
					]),
				attr),
			_List_Nil);
...
var $author$project$Vectorian$searchUI = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				...
				_Utils_update(
					...
					{color: $surprisetalk$elm_bulma$Bulma$Modifiers$White, size: $surprisetalk$elm_bulma$Bulma$Modifiers$Small}),
				_List_Nil,
				_List_fromArray(
					[
						A2(
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$src('static/vectorian.png')
											]),
										_List_Nil)
									]))
							]))
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										...
										_Utils_update(
											...
											{
												disabled: !_Utils_eq(model.search, $author$project$Vectorian$NotSearching),
												expanded: true
											}),
										_List_fromArray(
											[
												$author$project$Vectorian$onKeyDown($author$project$Msg$QueryKeyDown),
												$elm$html$Html$Events$onInput($author$project$Msg$QueryInput)
											]),
										_List_fromArray(
											[
												$elm$html$Html$Attributes$placeholder('Ask me and thou shall know.')
											]),
										_List_Nil),
										$author$project$Vectorian$searchButton(model)
									])),
								A2(
								$elm$html$Html$div,
								_List_Nil,
										...
										return _List_fromArray(
											[
												...
												_Utils_update(
													...
													{color: $surprisetalk$elm_bulma$Bulma$Modifiers$Primary, size: $surprisetalk$elm_bulma$Bulma$Modifiers$Small}),
												_List_Nil,
												progress)
											]);
									} else {
															...
															[
																...
																_List_fromArray(
																	[
																		...
																		_List_fromArray(
																			[
																				$elm$html$Html$text('Mismatch Length Penalty')
																			])),
																		A2(
																		$elm$html$Html$span,
																		_List_fromArray(
																		...
																		_List_fromArray(
																			[
																				$elm$html$Html$text(
																				'50% rel. after ' + ($elm$core$String$fromInt(model.querySettings.mismatchLengthPenalty) + ' t.'))
																			])),
																		A2(
																		$author$project$BulmaExtensions$mismatchCutoffSlider,
																		_List_fromArray(
																			[
																				A2(
																				$elm$html$Html$Attributes$attribute,
																				'value',
																				$elm$core$String$fromInt(model.querySettings.mismatchLengthPenalty)),
																				$author$project$Vectorian$onSliderInput(
																				function (x) {
																					if (x.$ === 'Just') {
																						var c = x.a;
																						return $author$project$Msg$UpdateQuerySettings(
																							$author$project$Msg$MismatchLengthPenalty(
																								$elm$core$Maybe$Just(
																									$elm$core$Basics$floor(c))));
																					} else {
																		...
																		_List_fromArray(
																			[
																				$elm$html$Html$text(
																				A2($myrho$elm_round$Round$round, 0, model.querySettings.submatchWeight))
																			])),
																		A3(
																		$author$project$BulmaExtensions$intSlider,
																		10,
																		_List_fromArray(
																			[
																				A2(
																				$elm$html$Html$Attributes$attribute,
																				'value',
																				$elm$core$String$fromFloat(model.querySettings.submatchWeight)),
																				$author$project$Vectorian$onSliderInput(
																				function (x) {
																					return $author$project$Msg$UpdateQuerySettings(
																...
																_List_fromArray(
																	[
																		...
																		_List_fromArray(
																			[
																				$elm$html$Html$text(
																				A2($myrho$elm_round$Round$round, 0, model.querySettings.idfWeight))
																			])),
																		A2(
																		$author$project$BulmaExtensions$slider,
																		_List_fromArray(
																			[
																				...
																				$elm$html$Html$Attributes$attribute,
																				'value',
																				$elm$core$String$fromFloat(model.querySettings.idfWeight)),
																				$author$project$Vectorian$onSliderInput(
																				function (x) {
																					return $author$project$Msg$UpdateQuerySettings(
																						$author$project$Msg$IDFWeight(x));
																				})
																			]),
																		'slider-idf-weight')
																	]))
								...
								$elm$core$List$isEmpty(model.results) ? A2($elm$html$Html$span, _List_Nil, _List_Nil) : A3(
								$surprisetalk$elm_bulma$Bulma$Layout$section,
								$surprisetalk$elm_bulma$Bulma$Layout$NotSpaced,
								_List_Nil,
								_List_fromArray(
									[
										A3(
										$surprisetalk$elm_bulma$Bulma$Form$fields,
										$surprisetalk$elm_bulma$Bulma$Modifiers$Right,
										_List_Nil,
										_List_fromArray(
											[
												A3(
												...
												_Utils_ap(
													_List_fromArray(
														[
															...
															function (x) {
																return $author$project$Msg$UpdateQuerySettings(
																	$author$project$Msg$AnnotatePOS(x));
															})
														]),
													$author$project$Vectorian$checked(model.querySettings.annotatePOS)),
												'id-annotate-pos',
												'Annotations')
											]))
									])),
								...
								A2(
									$elm$core$List$map,
									function (r) {
										return A2($author$project$Vectorian$matchView, model, r);
									},
									A2($elm$core$List$take, 100, model.results)))
							]))
					]))
			]));
};
var $author$project$Vectorian$view = function (model) {
	return A2(
		$elm$html$Html$main_,
		_List_Nil,
		model.connected ? _List_fromArray(
			[
				$author$project$Vectorian$searchUI(model)
			]) : _List_fromArray(
			[
				A3(
				$surprisetalk$elm_bulma$Bulma$Layout$section,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Lost server connection. Please try again later.')
							]))
					]))
			]));
};
var $author$project$Vectorian$main = $elm$browser$Browser$element(
	{
		init: function (_v0) {
			return $author$project$Vectorian$init;
		},
		subscriptions: $author$project$Vectorian$subscriptions,
		update: $author$project$Vectorian$update,
		view: $author$project$Vectorian$view
	});
_Platform_export({'Vectorian':{'init':$author$project$Vectorian$main(
